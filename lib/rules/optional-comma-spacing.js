/**
 * @fileoverview Comma spacing - optionally validates spacing before and after comma
 * @author Vignesh Anand aka vegetableman and slightly modified by greggman.
...
module.exports = function(context) {
    var options = {
        before: context.options[0] ? context.options[0].before : undefined,
        after:  context.options[0] ? context.options[0].after  : undefined,
    };
    ...
    function validateCommaItemSpacing(previousItemToken, commaToken, currentItemToken, reportItem) {
        if (isSameLine(previousItemToken, commaToken) &&
            ...
            if (options.before !== undefined && options.before !== isSpaced(previousItemToken, commaToken)) {
                report(reportItem, "before");
            }
            if (options.after !== undefined && options.after !== isSpaced(commaToken, currentItemToken)) {
